...
```{r pixar_ratings_overview, fig.height=5, fig.width=6}
df %>%
...
```{r pixar_ratings_overview_facet, fig.height=5, fig.width=6}
df %>%
  ggplot(aes(x = film, y = value, col = ratings)) +
  geom_point() +
  geom_line(aes(group = ratings)) +
...
```{r pixar_ratings_group, fig.height=6, fig.width=5}
df %>%
